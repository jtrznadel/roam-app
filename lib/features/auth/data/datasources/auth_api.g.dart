...
class _AuthApi implements AuthApi {
  ...
  Future<RequestEmailOtpResponse> requestEmailOtp(
    RequestEmailOtpRequest requestEmailOtpRequest,
  ) async {
    final _extra = <String, dynamic>{};
    final queryParameters = <String, dynamic>{};
    final _headers = <String, dynamic>{};
    final _data = <String, dynamic>{};
    _data.addAll(requestEmailOtpRequest.toJson());
    final _options = _setStreamType<RequestEmailOtpResponse>(
    ...
    late RequestEmailOtpResponse _value;
    try {
      _value = RequestEmailOtpResponse.fromJson(_result.data!);
    } on Object catch (e, s) {
  ...
  Future<AuthSessionModel> refreshSession(
    ...
    final _headers = <String, dynamic>{};
    final _data = <String, dynamic>{};
    _data.addAll(refreshSessionRequest.toJson());
    final _options = _setStreamType<AuthSessionModel>(
      Options(method: 'POST', headers: _headers, extra: _extra)
          .compose(
            _dio.options,
